...
def createTextureQuadAdvance(nx0, nx1, ny0, ny1):
    ...
    vertices = [
    #   positions        texture
        -0.5, -0.5, 0.0,  nx0, ny1, # esq inf izq
         0.5, -0.5, 0.0, nx1, ny1, # esq inf der
         0.5,  0.5, 0.0, nx1, ny0, # esq sup der
        -0.5,  0.5, 0.0,  nx0, ny0] # esq sup izq
...
def createTextureNormalsCubeAdvanced(image_filename, nx, ny):
    # Defining locations,texture coordinates and normals for each vertex of the shape
    vertices = [
        #   positions            tex coords   normals
        # Z+
